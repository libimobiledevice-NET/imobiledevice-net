...
namespace iMobileDevice.InstallationProxy
{
    ...
    public class InstallationProxyException : System.Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstallationProxyException"/> class with a specified error code and error message.
        /// </summary>
        /// <param name="error">
        /// The error code of the error that occurred.
        /// </param>
        ...
        public InstallationProxyException(InstallationProxyError error, string message) : 
                base(string.Format("An InstallationProxy error occurred. {1}. The error code was {0}", error, message))
        {
            this.errorCode = error;
        }
