...
namespace iMobileDevice.PropertyListService
{
    ...
    public partial class PropertyListServiceApi : IPropertyListServiceApi
    {
        ...
        /// PROPERTY_LIST_SERVICE_E_INVALID_ARG if one or more of the arguments are invalid.
        /// </returns>
        public virtual PropertyListServiceError property_list_service_get_service_client(PropertyListServiceClientHandle client, ref System.IntPtr serviceClient)
        {
            return PropertyListServiceNativeMethods.property_list_service_get_service_client(client, ref serviceClient);
        }
    }
}
