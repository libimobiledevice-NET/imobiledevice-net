...
namespace iMobileDevice.DebugServer
{
    ...
    public partial class DebugServerNativeMethods
    {
        ...
        /// code otherwise.
        /// </returns>
        [System.Runtime.InteropServices.DllImportAttribute(DebugServerNativeMethods.LibraryName, EntryPoint="debugserver_client_set_receive_params", CallingConvention=System.Runtime.InteropServices.CallingConvention.Cdecl)]
        public static extern DebugServerError debugserver_client_set_receive_params(DebugServerClientHandle client, ref CancelReceive cancelReceive, int receiveLoopTimeout);
