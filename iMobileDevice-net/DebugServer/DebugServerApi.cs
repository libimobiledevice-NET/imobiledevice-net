...
namespace iMobileDevice.DebugServer
{
    ...
    public partial class DebugServerApi : IDebugServerApi
    {
        ...
        /// code otherwise.
        /// </returns>
        public virtual DebugServerError debugserver_client_set_receive_params(DebugServerClientHandle client, ref CancelReceive cancelReceive, int receiveLoopTimeout)
        {
            return DebugServerNativeMethods.debugserver_client_set_receive_params(client, ref cancelReceive, receiveLoopTimeout);
        }
