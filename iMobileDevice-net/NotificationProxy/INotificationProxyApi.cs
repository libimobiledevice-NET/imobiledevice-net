...
// <copyright file="INotificationProxyApi.cs" company="Quamotion">
...
namespace iMobileDevice.NotificationProxy
{
    ...
    public partial interface INotificationProxyApi
    {
        ...
        /// established.
        /// </returns>
        NotificationProxyError np_client_new(iDeviceHandle device, LockdownServiceDescriptorHandle service, out NotificationProxyClientHandle client);
        ...
        /// code otherwise.
        /// </returns>
        NotificationProxyError np_client_start_service(iDeviceHandle device, out NotificationProxyClientHandle client, string label);
        ...
        /// </returns>
        NotificationProxyError np_client_free(System.IntPtr client);
        ...
        /// </returns>
        NotificationProxyError np_post_notification(NotificationProxyClientHandle client, string notification);
        ...
        /// </returns>
        NotificationProxyError np_observe_notification(NotificationProxyClientHandle client, string notification);
        ...
        /// </returns>
        NotificationProxyError np_observe_notifications(NotificationProxyClientHandle client, out string notificationSpec);
        ...
        /// </remarks>
        NotificationProxyError np_set_notify_callback(NotificationProxyClientHandle client, NotificationProxyNotifyCallBack notifyCallBack, System.IntPtr userData);
    }
}
