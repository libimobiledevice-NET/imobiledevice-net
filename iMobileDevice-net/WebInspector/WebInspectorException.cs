...
// <copyright file="WebInspectorException.cs" company="Quamotion">
...
#endif
    public class WebInspectorException : System.Exception
    {
        
        /// <summary>
        /// Backing field for the <see cref="ErrorCode"/> property.
        /// </summary>
        private WebInspectorError errorCode;
        
        /// <summary>
        /// Initializes a new instance of the <see cref="WebInspectorException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebInspectorException"/> class with a specified error code.
        /// </summary>
        /// <param name="error">
        /// The error code of the error that occurred.
        /// </param>
        public WebInspectorException(WebInspectorError error) : 
                base(string.Format("An WebInspector error occurred. The error code was {0}", error))
        {
            this.errorCode = error;
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="WebInspectorException"/> class with a specified error code and error message.
        /// </summary>
        /// <param name="error">
        /// The error code of the error that occurred.
        /// </param>
        ...
        public WebInspectorException(WebInspectorError error, string message) : 
                base(string.Format("An WebInspector error occurred. {1}. The error code was {0}", error, message))
        {
            this.errorCode = error;
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="WebInspectorException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebInspectorException"/> class with serialized data.
        /// </summary>
        /// <param name="info">
        ...
        /// </param>
#if !NETSTANDARD1_5
        protected WebInspectorException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : 
                base(info, context)
        {
        }
#endif
        ...
        /// </summary>
        public virtual WebInspectorError ErrorCode
        {
            get
            {
