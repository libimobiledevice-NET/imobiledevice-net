...
// <copyright file="PlistHandleDelegateMarshaler.cs" company="Quamotion">
...
namespace iMobileDevice.Plist
{
    ...
    public partial class PlistHandleDelegateMarshaler : System.Runtime.InteropServices.ICustomMarshaler
    {
        
        public static System.Runtime.InteropServices.ICustomMarshaler GetInstance(string cookie)
        {
            return new PlistHandleDelegateMarshaler();
        }
        ...
        {
            return PlistHandle.DangerousCreate(nativeData, false);
        }
    }
}
