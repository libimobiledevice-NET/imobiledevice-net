...
// <copyright file="PlistException.cs" company="Quamotion">
...
namespace iMobileDevice.Plist
{
    ...
    /// Represents an exception that occurred when interacting with the Plist API.
#if !NETSTANDARD1_5
    ...
    public class PlistException : System.Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlistException"/> class with a specified error code.
        /// </summary>
        /// <param name="error">
        /// The error code of the error that occurred.
        /// </param>
        public PlistException(PlistError error) : 
                base(string.Format("An Plist error occurred. The error code was {0}", error))
        {
            this.errorCode = error;
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="PlistException"/> class with a specified error code and error message.
        /// </summary>
        /// <param name="error">
        /// The error code of the error that occurred.
        /// </param>
        ...
        /// </param>
        public PlistException(PlistError error, string message) : 
                base(string.Format("An Plist error occurred. {1}. The error code was {0}", error, message))
        {
            this.errorCode = error;
        }
        ...
        /// </param>
        public PlistException(string message, System.Exception inner) : 
                base(message, inner)
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="PlistException"/> class with serialized data.
        /// </summary>
        /// <param name="info">
        ...
        /// </param>
#if !NETSTANDARD1_5
        protected PlistException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : 
                base(info, context)
        {
        }
#endif
        ...
        /// </summary>
        public virtual PlistError ErrorCode
        {
            get
            {
