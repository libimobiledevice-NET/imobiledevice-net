...
namespace iMobileDevice.SyslogRelay
{
    ...
    public partial interface ISyslogRelayApi
    {
        ...
        /// </returns>
        SyslogRelayError syslog_relay_client_new(iDeviceHandle device, LockdownServiceDescriptorHandle service, out SyslogRelayClientHandle client);
        ...
        /// code otherwise.
        /// </returns>
        SyslogRelayError syslog_relay_client_start_service(iDeviceHandle device, out SyslogRelayClientHandle client, string label);
        ...
        /// client is NULL, or an SYSLOG_RELAY_E_* error code otherwise.
        /// </returns>
        SyslogRelayError syslog_relay_client_free(System.IntPtr client);
        ...
        /// </returns>
        SyslogRelayError syslog_relay_start_capture(SyslogRelayClientHandle client, SyslogRelayReceiveCallBack callback, System.IntPtr userData);
        ...
        /// </remarks>
        SyslogRelayError syslog_relay_start_capture_raw(SyslogRelayClientHandle client, SyslogRelayReceiveCallBack callback, System.IntPtr userData);
        ...
        /// error occurs or a syslog capture has already been started.
        /// </returns>
        SyslogRelayError syslog_relay_stop_capture(SyslogRelayClientHandle client);
        ...
        /// error occurs.
        /// </returns>
        SyslogRelayError syslog_relay_receive_with_timeout(SyslogRelayClientHandle client, byte[] data, uint size, ref uint received, uint timeout);
        ...
        /// </returns>
        SyslogRelayError syslog_relay_receive(SyslogRelayClientHandle client, byte[] data, uint size, ref uint received);
    }
}
