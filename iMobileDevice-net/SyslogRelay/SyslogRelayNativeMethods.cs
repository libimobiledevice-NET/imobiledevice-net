...
namespace iMobileDevice.SyslogRelay
{
    ...
    public partial class SyslogRelayNativeMethods
    {
        ...
        /// </remarks>
        [System.Runtime.InteropServices.DllImportAttribute(SyslogRelayNativeMethods.LibraryName, EntryPoint="syslog_relay_start_capture_raw", CallingConvention=System.Runtime.InteropServices.CallingConvention.Cdecl)]
        public static extern SyslogRelayError syslog_relay_start_capture_raw(SyslogRelayClientHandle client, SyslogRelayReceiveCallBack callback, System.IntPtr userData);
