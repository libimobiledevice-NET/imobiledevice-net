...
namespace iMobileDevice.Lockdown
{
    ...
    public partial class LockdownApi : ILockdownApi
    {
        ...
        /// </returns>
        public virtual LockdownError lockdownd_pair(LockdownClientHandle client, LockdownPairRecordHandle pairRecord)
        {
            return LockdownNativeMethods.lockdownd_pair(client, pairRecord);
        }
        ...
        /// </returns>
        public virtual LockdownError lockdownd_cu_pairing_create(LockdownClientHandle client, LockdownCuPairingCallBack pairingCallback, System.IntPtr callBackUserData, PlistHandle hostInfo, PlistHandle acl)
        {
            return LockdownNativeMethods.lockdownd_cu_pairing_create(client, pairingCallback, callBackUserData, hostInfo, acl);
        }
        ...
        /// or a LOCKDOWN_E_* error code otherwise.
        /// </returns>
        public virtual LockdownError lockdownd_cu_send_request_and_get_reply(LockdownClientHandle client, string request, PlistHandle requestPayload, out PlistHandle reply)
        {
            LockdownError returnValue;
            returnValue = LockdownNativeMethods.lockdownd_cu_send_request_and_get_reply(client, request, requestPayload, out reply);
            reply.Api = this.Parent;
            return returnValue;
        }
        ...
        /// or a LOCKDOWN_E_* error code otherwise.
        /// </returns>
        public virtual LockdownError lockdownd_get_value_cu(LockdownClientHandle client, string domain, string key, out PlistHandle value)
        {
            LockdownError returnValue;
            returnValue = LockdownNativeMethods.lockdownd_get_value_cu(client, domain, key, out value);
            value.Api = this.Parent;
            return returnValue;
        }
        ...
        /// code otherwise.
        /// </returns>
        public virtual LockdownError lockdownd_pair_cu(LockdownClientHandle client)
        {
            return LockdownNativeMethods.lockdownd_pair_cu(client);
        }
