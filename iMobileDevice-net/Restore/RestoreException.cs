...
namespace iMobileDevice.Restore
{
    ...
    public class RestoreException : System.Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreException"/> class with a specified error code and error message.
        /// </summary>
        /// <param name="error">
        /// The error code of the error that occurred.
        /// </param>
        ...
        public RestoreException(RestoreError error, string message) : 
                base(string.Format("An Restore error occurred. {1}. The error code was {0}", error, message))
        {
            this.errorCode = error;
        }
